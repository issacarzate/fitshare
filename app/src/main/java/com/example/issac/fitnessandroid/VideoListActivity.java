...
public class VideoListActivity extends AppCompatActivity implements YouTubeThumbnailView.OnInitializedListener, YouTubeThumbnailLoader.OnThumbnailLoadedListener, YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thumbnailView.initialize("AIzaSyDPwV66naSF2UNwe8pK7CZQssYMRO9L3oA", this);
        playerFragment = (YouTubePlayerFragment) getFragmentManager().findFragmentById(R.id.VideoFragment);
        playerFragment.initialize("AIzaSyDPwV66naSF2UNwe8pK7CZQssYMRO9L3oA", this);
    }
    ...
    public void onInitializationSuccess(YouTubeThumbnailView youTubeThumbnailView, YouTubeThumbnailLoader youTubeThumbnailLoader) {
        ...
        youTubeThumbnailLoader.setOnThumbnailLoadedListener(VideoListActivity.this);
        thumbnailLoader.setPlaylist("PL47C159CCE65E8D53");
    }
